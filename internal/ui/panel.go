...
func (m Model) footerText() string {
	const globalKeys = "?: ヘルプ  q: 終了  |  1/2/3/4, /, t: パネル移動"

	switch m.focusedPanel {
	case focusSearch:
		return "文字入力: 絞り込み  Enter: 一覧へ戻る  Esc: クリアして一覧へ戻る"
	case focusTags:
		return "j/k: 移動  Enter/Space: 選択  Esc: 一覧へ戻る  n: 新規メモ  dd: 削除  " + globalKeys
	case focusTodos:
		return "j/k: 移動  Enter/e: 編集  Space: 完了切替  n: 新規todo  dd: 削除  D: 完了済み削除  " + globalKeys
	default: // focusList
		return "j/k: 移動  Enter/e: 編集  n: 新規メモ  dd: 削除  " + globalKeys
	}
}
